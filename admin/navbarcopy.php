<nav class="navbar navbar-expand-lg bg-body-tertiary border border-dark rounded p-4">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="logoImage/logo.png" style="width:80px; height:80px" class="img-responsive"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" herf="viewProduct.php">View Product</a>
        </li>
      <li class= "nav-item">
